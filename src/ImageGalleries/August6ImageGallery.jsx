// 1st August AKH3 Layout - 4 images with selective rounded corners
const August6ImageGallery = ({ images, isVisible }) => {
  return (
...
export default August6ImageGallery;