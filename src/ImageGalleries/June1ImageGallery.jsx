// June 25th Layout - Single large image on top with 2 smaller images below (3 total)
const June1ImageGallery = ({ images, isVisible }) => {
  return (
    <div className="flex flex-col gap-4 lg:h-160"> {/* Changed to flex-col for vertical stacking */}
      {/* Top - Large image */}
      <div
...
export default June1ImageGallery;