// August 16th Layout - Single large image on top with 2 smaller images below (3 total)
const August4ImageGallery = ({ images, isVisible }) => {
  return (
...
export default August4ImageGallery;