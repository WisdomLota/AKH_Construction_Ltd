...
const Home = () => {
    return (
      ...
      <div style={{backgroundImage: `url(${explorePic})`, backgroundSize: "cover", backgroundPosition: "center"}} className="h-fit rounded-bl-4xl">
        {/* Navigation */}
        <NavBar/>
          ...
          <div className="absolute bottom-0 left-0 right-0 p-16 text-white">
            <div className="container">
              ...
              <div className="inline-flex items-center pb-2 group cursor-pointer">
                <span className="mr-4 font-medium border-b-2 border-white ">EXPLORE REALTY</span>
